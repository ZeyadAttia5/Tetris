...
typedef struct DotMatrix
{
    ...
    u8 (*movePixelUp)(u8 *buffer, u8 copy_x, u8 copy_y);    // pointer to function that moves a pixel up
    u8 (*movePixelDown)(u8 *buffer, u8 copy_x, u8 copy_y);  // pointer to function that moves a pixel down
    u8 (*movePixelLeft)(u8 *buffer, u8 copy_x, u8 copy_y);  // pointer to function that moves a pixel left
    u8 (*movePixelRight)(u8 *buffer, u8 copy_x, u8 copy_y); // pointer to function that moves a pixel right
