	...
	if ((Copy_u8PortId > IOC) || (Copy_u8PinId > PIN15)
		...
		case OUTPUT_LS:
			...
			case IOA:
				...
				break;
			case IOB:
				CLR_BIT(GPIOB->OSPEEDR, (Copy_u8PinId * 2));
				CLR_BIT(GPIOB->OSPEEDR, ((Copy_u8PinId * 2) + 1));
				break;
			case IOC:
				CLR_BIT(GPIOC->OSPEEDR, (Copy_u8PinId * 2));
		...
		case OUTPUT_MS:
			...
			case IOA:
				...
				break;
			case IOB:
				SET_BIT(GPIOB->OSPEEDR, (Copy_u8PinId * 2));
				CLR_BIT(GPIOB->OSPEEDR, ((Copy_u8PinId * 2) + 1));
				break;
			case IOC:
				SET_BIT(GPIOC->OSPEEDR, (Copy_u8PinId * 2));
				CLR_BIT(GPIOC->OSPEEDR, ((Copy_u8PinId * 2) + 1));
				break;
			}
			break;
...
/*********************************************************************/
void GPIO_voidSetPinPuPdConfig(u8 Copy_u8PortId, u8 Copy_u8PinId,
		u8 Copy_u8PUPDType) {
	/*i/p Validation*/
	if ((Copy_u8PortId > IOC) || (Copy_u8PinId > PIN15)
			|| (Copy_u8PUPDType > INPUT_PD)) {
		/*Do Nothing*/
	} else {
		...
		case INPUT_FLOATING:
			...
			case IOA:
				...
				break;
			case IOB:
				CLR_BIT(GPIOB->PUPDR, (Copy_u8PinId * 2));
				CLR_BIT(GPIOB->PUPDR, ((Copy_u8PinId * 2) + 1));
				break;
			case IOC:
				CLR_BIT(GPIOC->PUPDR, (Copy_u8PinId * 2));
		...
		case INPUT_PU:
			...
			case IOA:
				...
				break;
			case IOB:
				SET_BIT(GPIOB->PUPDR, (Copy_u8PinId * 2));
				CLR_BIT(GPIOB->PUPDR, ((Copy_u8PinId * 2) + 1));
				break;
			case IOC:
				SET_BIT(GPIOC->PUPDR, (Copy_u8PinId * 2));
				CLR_BIT(GPIOC->PUPDR, ((Copy_u8PinId * 2) + 1));
				break;
			}
			break;
...
/* Desc. : This API allows user to Set the value of a specific pin*/
/*****************************************************************/
void GPIO_voidSetPinValueDirectAccess(u8 Copy_u8PortId, u8 Copy_u8PinId,
		u8 Copy_u8SetRstType) {
	/*i/p Validation*/
	if ((Copy_u8PortId > IOC) || (Copy_u8PinId > PIN15)
			|| (Copy_u8SetRstType > OUTPUT_SET)) {
		/*Do Nothing*/
	} else {
...
/*******************************************************************/
/* Func. Name: GPIO_voidSetPortMode                                */
/* i/p arguments: Copy_u8PortId: IOA, IOB, IOC                     */
/* i/p arguments: Copy_u8Mode: INPUT, OUTPUT, AF, ANALOG           */
/* o/p arguments: nothing                                          */
/* Desc. : This API allows user to Set the mode of a specific port */
/*******************************************************************/
void GPIO_voidSetPortMode(u8 Copy_u8PortId, u8 Copy_u8Mode) {
	/*i/p Validation*/
	if ((Copy_u8PortId > IOC) || (Copy_u8Mode > ANALOG)) {
		/*Do Nothing*/
	} else {
		for (u8 Copy_u8PinId = 0; Copy_u8PinId < 16; Copy_u8PinId++) {
